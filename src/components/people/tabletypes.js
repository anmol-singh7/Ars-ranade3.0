export const tableTypeMap = {
  Clients: { 
            tableHeads: ['Client ID', 'Client Name', 'Database No.'], 
            displayFields: ['clientid', 'clientname', 'databaseNum'], 
            endpoint: 'clients', 
            deleteendpoint: 'deleteclient',
            addnew:'client' 
          },

  Systems: { 
            tableHeads: ['System ID', 'System Name'], 
            displayFields: ['systemid', 'systemname'], 
            endpoint: 'systems', 
            deleteendpoint: 'deletesystem',
            addnew:'system' 
          },

  Manufacturers: { 
            tableHeads: ['Manufacturer ID', 'Manufacturer Name'], 
            displayFields: ['manufacturerid', 'manufacturername'], 
            endpoint: 'manufacturers', 
            deleteendpoint: 'deletemanufacturer',
            addnew:'manufacturer' 
          },

  Users: { 
            tableHeads: ['User ID', 'User Name'], 
            displayFields: ['userid', 'username'], 
            endpoint: 'users', 
 ...
 export const ReoprtTavleMap={
  
   Reports: { 
             tableHeads: ['Report ID', 'Report Name', 'Date', 'Status'], 
             displayFields: ['reportid', 'reportname', 'datebegin', 'status1'], 
             endpoint: 'reports', 
             deleteendpoint: 'deletereport' },
 }
