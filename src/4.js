                            ...
                            return (
                                <>
                                    <td>  {colIndex === 0 ? (
                                        ...
                                        >
                                            <option value="-">{col.dat[rowIndex]}</option>
                ...
                <table className="finalformcreate-table "
                    ...
                    <tbody className="finalformcreate-tbody">
                        <tr className="finalformcreate-tr">
                            ...
                            <Modal2 initialData={list} markedData={headi2} dropdowndata={atList} addheadi2={addheadi2} setHeadi2={setHeadi2} style={{ zIndex: "3" }} />
                        </tr>
                        {body.map((row, index) => (


                            // bodytable(row,headi2)
                            bodytable(row, headi2, atList)
                        ))}
                    </tbody>
